...
let Voznja = class Voznja {
    constructor(lokacija_od_lat, lokacija_od_lon, lokacija_do_lat, lokacija_do_lon, ocena, u_toku, datum) {
...
__decorate([
    typeorm_1.ManyToOne(type => Taksista_1.Taksista, taxi => taxi.lista_voznji, { onDelete: 'CASCADE' }),
